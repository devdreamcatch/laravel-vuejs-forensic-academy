...
<!-- START_51c82bfafde1e69bebe607e8374440f7 -->
## Profile update
...
<!-- END_51c82bfafde1e69bebe607e8374440f7 -->

<!-- START_905fa5c8056579acd384c8a798572cbb -->
## Profile show
...
```bash
curl -X GET \
    -G "http://localhost/api/profile/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
<!-- END_905fa5c8056579acd384c8a798572cbb -->
