    ...
    @mouseout  = "mouseout">
      ...
      <div @click="clickGroup" class="group-header w-full">
        <span class="flex items-center w-full">
          ...
          <!-- Group Name -->
          <span v-show="!verticalNavMenuItemsMin" class="truncate mr-3 select-none">{{ $t(group.i18n) }}</span>
        ...
        <!-- Group Tooltip -->
        <span class="vs-sidebar--tooltip">{{ $t(group.i18n) }}</span>
      </div>
      <!-- /Group Label -->
        ...
        <li v-for="(groupItem, index) in group.submenu" :key="index">
          ...
          <v-nav-menu-item
            ...
            :target = "groupItem.target">
              <span class="truncate">{{ $t(groupItem.i18n) }}</span>
